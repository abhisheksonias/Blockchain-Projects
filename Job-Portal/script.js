...
const contractAddress = '0xc56c136294277dd351c76c358cef8c93a9b2963f'; // Replace with your deployed contract address
        ...
        for (let i = 1; i <= count; i++) {
            try {
                ...
                card.innerHTML = `
                    ...
                    <p><strong>Type:</strong> ${typeNames[type]}</p>
                    <p><strong>Available:</strong> ${details.isAvailable ? 'Yes' : 'No'}</p>
                    <button onclick="document.getElementById('applicantId').value=${details.id}; document.getElementById('getApplicantBtn').click();">
                        View Details
                    </button>
                `;
                ...
                console.error(`Error getting applicant ${i}:`, error);
            }
        }
